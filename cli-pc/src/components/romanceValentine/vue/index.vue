...
<div class="hd-common">
    <el-breadcrumb separator="/" class="gt-crumbs">
      ...
      <el-breadcrumb-item>浪漫七夕</el-breadcrumb-item>  
    </el-breadcrumb>
...
import { 
  ...
  export default{
    ...
    methods: { 
      ...
      //中奖记录
      record(val){
         this.$router.push({path: '/romanceValentine/prizeRecord', query: {id: val}});
      },
      //核销授权
      impower(val){
         this.$router.push({path: '/romanceValentine/cancelOut', query: {id: val}});
      },
      addActive(){
        this.$router.push('/romanceValentine/addAct')
      },
      editActive(val){
        this.$router.push({path:'/romanceValentine/editAct', query: {id: val}});
      },
      test(){
        console.log(123)
      }
