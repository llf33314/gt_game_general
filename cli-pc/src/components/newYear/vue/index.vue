...
<div class="hd-common">
    <el-breadcrumb separator="/" class="gt-crumbs">
      ...
      <el-breadcrumb-item>元旦跨年跳跃</el-breadcrumb-item>  
    </el-breadcrumb>
...
import { 
  ...
  export default{
    ...
    methods: { 
      ...
      //中奖记录
      record(val){
         this.$router.push({path: '/newYear/prizeRecord', query: {id: val}});
      },
      //核销授权
      impower(val){
         this.$router.push({path: '/newYear/cancelOut', query: {id: val}});
      },
      addActive(){
        this.$router.push('/newYear/addAct')
      },
      editActive(val){
        this.$router.push({path:'/newYear/editAct', query: {id: val}});
      },
      test(){
        console.log(123)
      }
