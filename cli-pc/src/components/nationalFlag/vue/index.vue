...
<div class="hd-common">
    <el-breadcrumb separator="/" class="gt-crumbs">
      ...
      <el-breadcrumb-item>升国旗</el-breadcrumb-item>  
    </el-breadcrumb>
...
import { 
  ...
  export default{
    ...
    methods: { 
      ...
      //中奖记录
      record(val){
         this.$router.push({path: '/nationalFlag/prizeRecord', query: {id: val}});
      },
      //核销授权
      impower(val){
         this.$router.push({path: '/nationalFlag/cancelOut', query: {id: val}});
      },
      addActive(){
        this.$router.push('/nationalFlag/addAct')
      },
      editActive(val){
        this.$router.push({path:'/nationalFlag/editAct', query: {id: val}});
      },
      test(){
        console.log(123)
      }
