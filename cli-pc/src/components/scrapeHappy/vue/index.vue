  ...
  <section>
    <div class="hd-common">
      <el-breadcrumb separator="/" class="gt-crumbs">
        ...
        <el-breadcrumb-item>刮刮乐</el-breadcrumb-item>
      </el-breadcrumb>
      ...
      <div class="gt-content">
        ...
        <div class="public-page-fr">
          <el-pagination @current-change="handleCurrentChange" :current-page.sync="current" :page-size="10" v-if="this.tableData.page.totalNums!=0" layout="prev, pager, next, jumper" :total="tableData.page.totalNums">
          </el-pagination>
        </div>
      </div>
      <!-- 链接 -->
...
<script>
import { getActList, getMobileUrl, getShortUrl, getActCount, delAct, stopLuck } from './../api/api'
export default {
  data() {
    return {
      keyWord: "",
