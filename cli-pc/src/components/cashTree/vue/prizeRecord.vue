...
<script>
import {  getPrizeList,givePrize,getPrizeType}from './../api/api'
  export default{
     data() {
      return { 
        prizeType:"-1",
    ...
    methods: {  
      ...
      toExport(){
        ...
        params.type   = this.prizeType; 
        params.snCode = this.codeWord;  
        window.open(window.BASEDOMAIN+'/app/goldtree/exports?actId='+params.actId+'&status='+params.status+'&type='+params.type+'&snCode='+params.snCode);   
      },
      //发放奖品  
      handOut(id){
