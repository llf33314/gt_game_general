    ...
    <div class="gt-content">
          ...
          <el-form :model="ruleForm1" :rules="rules1" ref="ruleForm1" label-width="120px" class="demo-ruleForm">
            ...
            <el-table ref="multipleTable" :data="ruleForm1.links" tooltip-effect="dark">
                ...
                <el-table-column label="操作">
                  <template slot-scope="scope">
                        <el-button class="gt-button-normal" @click="delLinks(scope.row.id)">删除</el-button>
                  </template>
                </el-table-column> 
             </el-table> 
          </el-form> 
        ...
        <div v-if="this.active==3" class="mt40">
            ...
            <el-table ref="multipleTable" :data="ruleForm4" tooltip-effect="dark">
                ...
                <template slot-scope="scope"> 
                    <gt-material prop="url" :url="scope.row.name4" v-on:getChangeUrl="getChangeUrl4(scope.row.typeId, $event)" width="72" height="72"></gt-material>
                </template>
                </el-table-column>
                <el-table-column label="操作">
                <template slot-scope="scope">
                    <el-button class="gt-button-normal blue" @click="delForm4(scope.row.typeId)">删除</el-button>
                </template>
                </el-table-column>
            </el-table>  
        </div>       
...
export default {
  ...
  methods: {   
    ...
    delLinks(val) {
       this.ruleForm1.links.forEach((v, i) => {
        if (v.id == val) {
          this.ruleForm1.links.splice(i, 1);
        }
      }); 
    },
    getChangeUrl(i,e) { 
    ...
    addForm4(){
        this.typeId++
        this.ruleForm4.push({typeId:this.typeId, name0: 1, name1: "", name2: "", name3: "", name4: ""},)
    },
    delForm4(val){
