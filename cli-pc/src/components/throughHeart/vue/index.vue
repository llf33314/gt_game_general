...
<div class="hd-common">
    <el-breadcrumb separator="/" class="gt-crumbs">
      ...
      <el-breadcrumb-item>一箭穿心</el-breadcrumb-item>  
    </el-breadcrumb>
...
import { 
  ...
  export default{
    ...
    methods: { 
      ...
      //中奖记录
      record(val){
         this.$router.push({path: '/throughHeart/prizeRecord', query: {id: val}});
      },
      //核销授权
      impower(val){
         this.$router.push({path: '/throughHeart/cancelOut', query: {id: val}});
      },
      addActive(){
        this.$router.push('/throughHeart/addAct')
      },
      editActive(val){
        this.$router.push({path:'/throughHeart/editAct', query: {id: val}});
      },
      test(){
        console.log(123)
      }
