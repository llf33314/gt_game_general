        ...
        <div v-if="this.active==0" class="mt40">
            <el-form :model="ruleForm1" :rules="rules1" ref="ruleForm1" label-width="120px" class="demo-ruleForm">
                ...
                <el-form-item label="结束说明：" prop="desc">
                    <el-input class="w_demo"  type="textarea" v-model="ruleForm1.desc" :rows="3" placeholder="请输入活动结束说明"></el-input>
                    <div class="el-upload__tip grey" style="line-height:25px">可详细填写活动结束说明，让粉丝了解此次活动已结束。如：秦代的粉丝们，
                        <br/>此次活动已结束，感谢你们的关注与参与，敬请期待下次活动的开展。
                    </div>
                </el-form-item>  
                ...
                <div class="pd20 bw bb ml120 mb20" v-if="ruleForm1.resource==2">
        ...
        <div v-if="this.active==2" class="mt40">
            <el-form :model="ruleForm3" :rules="rules3" ref="ruleForm3" label-width="120px" class="mt40 demo-ruleForm">
                ...
                <el-form-item label="兑奖提示：">
                    <el-input class="w_demo"  type="textarea" v-model="ruleForm3.tishi" :rows="5" 
                    placeholder="如：兑换奖品请阅读活动说明或联系相关工作人员确认兑换！兑奖请联系我们，电话0752-2366888"></el-input>
                </el-form-item>
                <el-form-item label="中奖须知：">
                    <el-input class="w_demo"  type="textarea" v-model="ruleForm3.xuzhi" :rows="5"
                     placeholder="如：1、如果是实物的奖品，要填写中奖人的手机号码，如不是现场兑奖的还要填写速递地址。"></el-input>
                </el-form-item>   
            </el-form> 
        </div>
        <!-- 奖项设置 -->
  ...
  data() {
    return {
      ...
      rules1: {
        ...
        name1: [
          { required: true, type: "array", message: "开始时间不能为空" }
        ] 
      },
      ruleForm2: {
        cishu: "",
