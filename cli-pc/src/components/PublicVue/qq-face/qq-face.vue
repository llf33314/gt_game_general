  ...
  <div class="emoji-components">
    <div class="emoji-content">
      <div class="emoji-title">
        ...
        :on-remove="handleRemove" :on-change="handleChange" :before-upload="beforeUpload"
        :show-file-list="false"
        :multiple="true" :auto-upload="false" >
        <i class="icon iconfont gt-tupian mg-l20"></i>
      </el-upload>
    ...
    <div class="community-post-picture" v-if="showUploadPicture">
      <el-upload class="upload-demo" ref="upload" action="https://jsonplaceholder.typicode.com/posts/" :on-preview="handlePreview"
...
export default {
  data() {
    return {
      ...
      fileListItem: [{
               name: '',
               url: 'http://maint.deeptel.com.cn/upload//image/3/goodtom/3/20171215/84AD2BB74A295D36ABA8272E89E20F4B.png'
      }],
      dialogImageUrl: "",
      dialogVisible: false,
    };
  ...
  created() {
    this.fileListItem = this.imgArray
    this.textareaEmoji = this.content
  },
  mouted() { },
  watch: {
    textareaEmoji: {
