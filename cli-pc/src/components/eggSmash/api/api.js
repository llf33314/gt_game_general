...
export default {
       ...
       getActivityList(params) {
           return post(`${base}/getEggsList`, params)
       },
       // 删除活动
       delActivity(params) { 
           return post(`${base}/delEggs`, params) 
       }, 
       // 获取手机端链接 
       getMobileUrl(params) {
       ...
       // 新增活动 
       addActivity(params) {
           return post(`${base}/addEggs`, params)    
       },
       // 通过活动id查询活动 
       ...
       modfiyActivity(params) {
        return post(`${base}/modfiyEggs`, params)  
       },
       ...
       getAuthorityList(params) {
        return post(`${base}/getEggsAuthorityList`, params) 
       }, 
       // 批量删除核销授权
       delAuthority(params) { 
        return post(`${base}/delEggsAuthority`, params) 
       },
       ...
       // 批量删除中奖记录 
       delWinning(params) {
        return post(`${base}/delEggsWinning`, params) 
       },
       // 中奖记录发放奖品
       sendWinning(params) {
        return post(`${base}/editEggsApply`, params) 
       },
