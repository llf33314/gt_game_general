...
<div class="hd-common turnPlate">
    <el-breadcrumb separator="/" class="gt-crumbs">
      ...
      <el-breadcrumb-item>让红包飞</el-breadcrumb-item>  
    </el-breadcrumb>
    ...
    <div class="gt-content"> 
        ...
        <el-table :data="tableData.data">
          ...
          <el-table-column prop="state" label="红包状态">
            <template slot-scope="scope">
              {{scope.row.state|actStatus(scope.row.state)}} 
            </template> 
          </el-table-column>
          <el-table-column prop="endTime" label="红包总金额">
           
          </el-table-column>
          <el-table-column prop="state" label="红包类型">
            <template slot-scope="scope">
              {{scope.row.state|actStatus(scope.row.state)}} 
            </template> 
          </el-table-column>
          <el-table-column prop="order_option" width="400" label="操作">
            <template slot-scope="scope"> 
              ...
              <el-button class="gt-button-normal blue" @click="test(scope.row.id)">领取纪录</el-button>
...
<script>
  export default{
    ...
    methods: { 
      ...
      addActive(){
        this.$router.push('/redpachetFly/addAct')
      },
      test(){
        console.log(123)
      }
