...
//	public static final  String[] generatorTableName = new String[] {"t_wx_channels_main","t_wx_channels_type"};
    public static final  String[] generatorTableName = new String[] {"t_wx_activity_shakeluck_ad", "t_wx_activity_shakeluck_address", "t_wx_activity_shakeluck_authority",
    	"t_wx_activity_shakeluck_cash_prize_apply","t_wx_activity_shakeluck_main","t_wx_activity_shakeluck_play_record","t_wx_activity_shakeluck_prize","t_wx_activity_shakeluck_prize_img"};
