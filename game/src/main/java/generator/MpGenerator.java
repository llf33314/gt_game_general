...
//	public static final  String[] generatorTableName = new String[] {"t_wx_channels_main","t_wx_channels_type"};
    public static final  String[] generatorTableName = new String[] {"t_wx_activity_goldtree_ad", "t_wx_activity_goldtree_address", "t_wx_activity_goldtree_authority",
    	"t_wx_activity_goldtree_main","t_wx_activity_goldtree_play_record","t_wx_activity_goldtree_prize","t_wx_activity_goldtree_prize_apply","t_wx_activity_goldtree_prize_img"};
