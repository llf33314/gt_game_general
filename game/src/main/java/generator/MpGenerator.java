...
//	public static final  String[] generatorTableName = new String[] {"t_wx_channels_main","t_wx_channels_type"};
    public static final  String[] generatorTableName = new String[] {
    		"t_wx_activity_tree_detail", "t_wx_activity_tree_main", "t_wx_activity_tree_winning"
			//"t_wx_activity_ninelattice_main", "t_wx_activity_ninelattice_play_record", "t_wx_activity_ninelattice_prize",
			//"t_wx_activity_ninelattice_prize_img"
			};
