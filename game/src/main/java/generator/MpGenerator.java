...
//	public static final  String[] generatorTableName = new String[] {"t_wx_channels_main","t_wx_channels_type"};
    public static final  String[] generatorTableName = new String[] {"t_wx_activity_gold_rush_address", "t_wx_activity_gold_rush_authority", "t_wx_activity_gold_rush_cash_prize_apply",
			"t_wx_activity_gold_rush_main", "t_wx_activity_gold_rush_play_record", "t_wx_activity_gold_rush_prize", "t_wx_activity_gold_rush_prize_img"};
