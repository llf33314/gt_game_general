...
import com.gt.game.core.bean.goldtree.req.GoldtreeAdReq;
import com.gt.game.core.bean.goldtree.req.GoldtreeAddressReq;
import com.gt.game.core.bean.goldtree.req.GoldtreePrizeReq;
 ...
 * @since 2017-12-25
 */
@ApiModel("摇钱树查询活动返回对象")
public class GoldtreeRes {
