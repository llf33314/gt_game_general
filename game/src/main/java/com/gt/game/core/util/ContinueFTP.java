...
public class ContinueFTP
{
     ...
     * @throws IOException
     */
    public Map<String, Object> download(String local)
            throws Exception
    {
        if (!applyProperties.isFtpNeed()){
            return null;
        }
        connect(applyProperties.getFtpIp(), CommonUtil.toInteger(applyProperties.getFtpPort()), applyProperties.getFtpUser(), applyProperties.getFtpPwd());
        Boolean is_connect = connect(applyProperties.getFtpIp(), CommonUtil.toInteger(applyProperties.getFtpPort()), applyProperties.getFtpUser(), applyProperties.getFtpPwd());;
...
//                   InputStream in = ftpClient.retrieveFileStream(new String(remote.getBytes("GBK"), "iso-8859-1"));
     ...
     * @throws IOException
     */
    public Map<String, Object> upload(String local)
            throws Exception
    {
        if (!applyProperties.isFtpNeed()){
            return null;
