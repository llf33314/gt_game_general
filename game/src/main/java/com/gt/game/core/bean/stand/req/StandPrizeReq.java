 ...
 * @since 2017-12-25
 */
@ApiModel("一站到底活动保存奖品对象")
public class StandPrizeReq {
	/**
	 * 名称
	 */
	...
	private List<StandPrizeImgReq> standPrizeImgReqs;
	...
	public List<StandPrizeImgReq> getStandPrizeImgReqs() {
		return standPrizeImgReqs;
	}

	public void setStandPrizeImgReqs(List<StandPrizeImgReq> standPrizeImgReqs) {
		this.standPrizeImgReqs = standPrizeImgReqs;
	}
}
