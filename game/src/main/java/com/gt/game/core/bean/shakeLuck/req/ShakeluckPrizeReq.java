 ...
 * @since 2017-12-25
 */
@ApiModel("摇手气活动保存奖品对象")
public class ShakeluckPrizeReq {
	/**
	 * 名称
	 */
	...
	private List<ShakeluckPrizeImgReq> shakeluckPrizeImgReqs;
	/**
	 * 卡券包ID
	 */
	...
	public List<ShakeluckPrizeImgReq> getShakeluckPrizeImgReqs() {
		return shakeluckPrizeImgReqs;
	}

	public void setShakeluckPrizeImgReqs(List<ShakeluckPrizeImgReq> shakeluckPrizeImgReqs) {
		this.shakeluckPrizeImgReqs = shakeluckPrizeImgReqs;
	}
}
