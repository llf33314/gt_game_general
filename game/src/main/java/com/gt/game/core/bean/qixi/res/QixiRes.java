...
import com.gt.game.core.bean.qixi.req.QixiAdReq;
import com.gt.game.core.bean.qixi.req.QixiAddressReq;
import com.gt.game.core.bean.qixi.req.QixiPrizeReq;
 ...
 * @since 2017-12-25
 */
@ApiModel("浪漫七夕查询活动返回对象")
public class QixiRes {
