 ...
 * @since 2017-12-25
 */
@ApiModel("摇钱树活动保存奖品对象")
public class GoldtreePrizeReq {
	/**
	 * 名称
	 */
	...
	private List<GoldtreePrizeImgReq> goldtreePrizeImgReqs;
	...
	public List<GoldtreePrizeImgReq> getGoldtreePrizeImgReqs() {
		return goldtreePrizeImgReqs;
	}

	public void setGoldtreePrizeImgReqs(List<GoldtreePrizeImgReq> goldtreePrizeImgReqs) {
		this.goldtreePrizeImgReqs = goldtreePrizeImgReqs;
	}
}
