...
import com.gt.game.core.bean.goldRush.req.GoldRushAddressReq;
import com.gt.game.core.bean.goldRush.req.GoldRushPrizeReq;
 ...
 * @since 2017-12-25
 */
@ApiModel("欢乐抢元宝查询活动返回对象")
public class GoldRushRes {
