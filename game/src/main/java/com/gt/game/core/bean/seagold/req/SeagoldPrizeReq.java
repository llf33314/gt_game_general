 ...
 * @since 2017-12-25
 */
@ApiModel("大海捞金活动保存奖品对象")
public class SeagoldPrizeReq {
	/**
	 * 名称
	 */
	...
	public List<SeagoldPrizeImgReq> getSeagoldPrizeImgReqs() {
		return seagoldPrizeImgReqs;
	}

	public void setSeagoldPrizeImgReqs(List<SeagoldPrizeImgReq> seagoldPrizeImgReqs) {
		this.seagoldPrizeImgReqs = seagoldPrizeImgReqs;
	}
}
