 ...
 * @since 2017-12-25
 */
@ApiModel("拆礼盒活动保存奖品对象")
public class DemolitionPrizeReq {
	/**
	 * 名称
	 */
	...
	private List<DemolitionPrizeImgReq> demolitionPrizeImgReqs;
	...
	public List<DemolitionPrizeImgReq> getDemolitionPrizeImgReqs() {
		return demolitionPrizeImgReqs;
	}

	public void setDemolitionPrizeImgReqs(List<DemolitionPrizeImgReq> demolitionPrizeImgReqs) {
