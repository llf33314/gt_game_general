...
import com.gt.game.core.bean.loveArrow.req.LoveArrowAdReq;
import com.gt.game.core.bean.loveArrow.req.LoveArrowAddressReq;
import com.gt.game.core.bean.loveArrow.req.LoveArrowPrizeReq;
 ...
 * @since 2017-12-25
 */
@ApiModel("一箭穿心查询活动返回对象")
public class LoveArrowRes {
