...
public class JavaMailWithAttachment {
	...
	private static JavaMailWithAttachment sendEmail=null;  
	/*
	 * 初始化方法
	 */
	private JavaMailWithAttachment() {
	...
	public static JavaMailWithAttachment getInstence(){
		if(sendEmail == null){
			sendEmail = new JavaMailWithAttachment();
		}
		return sendEmail;
	}
	...
	public static void main(String[] args) {
		...
		se.doSendHtmlEmail("邮件主题", "邮件内容<a href=\"http://www.baidu.com\">请点击</a>", "13528307867@163.com", null);
	}
}
