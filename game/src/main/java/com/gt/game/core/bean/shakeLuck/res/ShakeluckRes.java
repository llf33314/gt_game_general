...
import com.gt.game.core.bean.shakeLuck.req.ShakeluckAdReq;
import com.gt.game.core.bean.shakeLuck.req.ShakeluckAddressReq;
import com.gt.game.core.bean.shakeLuck.req.ShakeluckPrizeReq;
 ...
 * @since 2017-12-25
 */
@ApiModel("摇手气查询活动返回对象")
public class ShakeluckRes {
